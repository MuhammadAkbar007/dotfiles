# Generated by Powerlevel10k configuration wizard on 2026-08-13 at 09:23 +05.
...
() {
  ...
  # Show the private IP address when on VPN. Set CONTENT_EXPANSION to '' for icon only.
